class ItemPurchaseAddress
  ...
  attr_accessor :token, :postal_code, :prefecture_id, :city, :address, :phone_number, :item_purchase, :building_name, :user_id,
                :item_id
  ...
  def save
    ...
    Address.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, address: address,
                   phone_number: phone_number, item_purchase_id: item_purchase.id, building_name: building_name)
  end
end
